...
ns = api.namespace('fitting/scannermodels/', description='Operations related to Scanner models')
...
class ScannerModels(Resource):
    ...
    def put(self, uuid):
        ...
        """
        scanner_model_obj = _scannerModelRep.update({'@rid': uuid}, request.json)[0]
    ...
    def delete(self, uuid):
        ...
        """
        _scannerModelRep.delete({'@rid': uuid})
        return None, 204
